...
public class RankService {
    ...
    public void createRank(String userId, int score) {
        ...
        if (deleteLowScore(userId, score)) {
    ...
    public void findRankTop20() {
        ...
        top20.stream()
            .forEach(rr -> {
                ...
                System.out.println(
                    count + "등 | 유저점수 ==>> " + rr.getScore() + " 아이디 ==>> " + rr.getUserId()
                        + " 생성된 날짜" + rr.getCreate());
            });
    }

    public int[] findMyRankbyUserId(String userId) {
        ...
        if (myRank.isEmpty()) {
            ...
            int IRank = top20.indexOf(myRank.get(0)) + 1;
            int[] myRankScore = {myRank.get(0).getScore(), IRank};
            return myRankScore;
        }
    }
}
